...
const MOTS_CLES = new Set([
  ...
  "as", "with", "try", "except", "finally", "raise", "lambda", "yield",
  "pass", "break", "continue", "global", "nonlocal", "del", "assert",
  "async", "await", "self",
  // TypeScript
  "const", "let", "var", "function", "new", "export", "default", "type",
  "interface", "enum", "extends", "implements", "readonly", "private",
  "public", "protected", "static", "this", "null", "undefined", "true",
  "false", "void", "typeof", "instanceof", "switch", "case", "throw",
  "catch", "do", "satisfies", "keyof", "infer", "declare", "namespace",
]);
